const DonorCard = ({ donor, onSelect }) => {
  ...
  return (
    <button
      ...
      className="bg-white border-2 border-gov-border rounded-sm p-4 hover:border-gov-red hover:shadow-md transition-all text-left"
    >
      ...
      {/* CTA Text */}
      <p className="text-xs text-gov-red mt-3 font-medium hover:underline">Click to request blood →</p>
    </button>
  );
};
